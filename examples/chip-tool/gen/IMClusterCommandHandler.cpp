...
while ((TLVError = dataTlv.Next()) == CHIP_NO_ERROR)
{
  ...
  {
    case 0:
      TLVError = dataTlv.Get(timeOfDay);
      break;
    case 1:
      TLVError = dataTlv.Get(relayStatus);
      break;
    case 2:
      TLVError = dataTlv.Get(localTemperature);
      break;
    case 3:
      TLVError = dataTlv.Get(humidityInPercentage);
      break;
    case 4:
      TLVError = dataTlv.Get(setpoint);
      break;
    case 5:
      TLVError = dataTlv.Get(unreadEntries);
      break;
    default:
      // Unsupported tag, ignore it.
      ChipLogProgress(Zcl, "Unknown TLV tag during processing.");
